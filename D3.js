...
console.log("Personaggi con i colori degli occhi blue: ", eyeColor.blue);
console.log("Personaggi con i colori degli occhi gialli: ", eyeColor.yellow);
console.log("Personaggi con i colori degli occhi marroni: ", eyeColor.brown);
console.log(
  "Personaggi con i colori degli occhi blue-gray ",
  eyeColor["blue-gray"]
);
...
while (c < starWarsCharacters.length) {
  ...
  // console.log("la massa di ogni passeggero è: ", starWarsCharacters[c].mass);
  c++;
}
